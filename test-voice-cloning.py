...
model_state = model.get_state_for_audio_prompt("vera.wav")
export_model_state(model_state, "./vera.safetensors")
...
model_state_copy = model.get_state_for_audio_prompt("./vera.safetensors")
